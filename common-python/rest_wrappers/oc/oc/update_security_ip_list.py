...
__module__ = "update-security-ip-list"
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
...
def main(argv):
    ...
    try:
        ...
        if moduleArgs['cookie'] is not None:
            jsonObj = updateSecurityIpList(moduleArgs['endpoint'], moduleArgs['resourcename'], moduleArgs['cookie'],
                                           moduleArgs['name'], moduleArgs['secipentries'])
            printJSON(jsonObj)
        else:
