...
def updateIPNetwork(endpoint, resourcename, cookie, name, ipaddressprefix, ipnetworkexchange):
    basepath = '/network/v1/ipnetwork/'
    params = None
    data = {"name": str(name), "ipAddressPrefix": str(ipaddressprefix), "ipNetworkExchange": str(ipnetworkexchange)}
