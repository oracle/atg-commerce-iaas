...
__module__ = "create-security-ip-list"
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
...
def readModuleArgs(opts, args):
    ...
    for opt, arg in opts:
        ...
        elif opt in ("-s", "--secipentries"):
            moduleArgs['secipentries'] = arg
...
def main(argv):
    ...
    try:
        ...
        if moduleArgs['cookie'] is not None:
            jsonObj = createSecurityIpList(moduleArgs['endpoint'], moduleArgs['resourcename'], moduleArgs['cookie'],
                                           moduleArgs['name'], moduleArgs['secipentries'], moduleArgs['description'])
            printJSON(jsonObj)
        else:
