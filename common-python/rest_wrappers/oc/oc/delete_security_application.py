...
__module__ = "delete-security-application"
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
...
def deleteSecurityApplication(endpoint, resourcename, cookie):
...
def main(argv):
    ...
    try:
        ...
        if moduleArgs['cookie'] is not None:
            jsonObj = deleteSecurityApplication(moduleArgs['endpoint'], moduleArgs['resourcename'],
                                                moduleArgs['cookie'])
            printJSON(jsonObj)
        else:
