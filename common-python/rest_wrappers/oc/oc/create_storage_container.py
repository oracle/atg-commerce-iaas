...
__module__ = "create_storage_container"
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
...
def createStorageContainer(endpoint, container, authtoken, **kwargs):
    basepath = ''
    headers = None
    params = None
    data = None
    files = None
    response = callRESTApi(endpoint, basepath, container, method='PUT', authtoken=authtoken, headers=headers, params=params, data=data, files=files)
