...
def updateRoute(endpoint, resourcename, cookie, name, ipaddressprefix, nexthopvnicset, admindistance):
    basepath = '/network/v1/route/'
    params = None
    data = {"name": str(name), "ipAddressPrefix": str(ipaddressprefix), "nextHopVnicSet": str(nexthopvnicset), "adminDistance": int(admindistance)}
