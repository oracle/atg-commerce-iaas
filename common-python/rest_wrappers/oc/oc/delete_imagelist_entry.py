...
__module__ = "delete-imagelist-entry"
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
...
def main(argv):
    ...
    options = 'e:u:p:P:R:C:V:'
    longOptions = ['endpoint=', 'user=', 'password=', 'pwdfile=', 'resourcename=', 'cookie=', 'version=']
    ...
    try:
        ...
        if moduleArgs['cookie'] is not None:
            jsonObj = deleteImageListEntry(moduleArgs['endpoint'], moduleArgs['resourcename'], moduleArgs['cookie'],
                                           moduleArgs['version'])
            printJSON(jsonObj)
        else:
