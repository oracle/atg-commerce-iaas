...
def createIPNetwork(endpoint, resourcename, cookie, name, ipaddressprefix):
    basepath = '/network/v1/ipnetwork/'
    params = None
    data = {"name": str(name), "ipAddressPrefix": str(ipaddressprefix)}
