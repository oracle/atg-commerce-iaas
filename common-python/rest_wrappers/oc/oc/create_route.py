...
def createRoute(endpoint, resourcename, cookie, name, ipaddressprefix, nexthopvnicset):
    basepath = '/network/v1/route/'
    params = None
    data = {"name": str(name), "ipAddressPrefix": str(ipaddressprefix), "nextHopVnicSet": str(nexthopvnicset)}
