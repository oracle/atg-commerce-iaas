...
def updateImagelist(endpoint, resourcename, cookie, name, description, default):
    basepath = '/imagelist/'
    params = None
...
def main(argv):
    ...
    try:
        ...
        if moduleArgs['cookie'] is not None:
            jsonObj = updateImagelist(moduleArgs['endpoint'], moduleArgs['resourcename'], moduleArgs['cookie'],
