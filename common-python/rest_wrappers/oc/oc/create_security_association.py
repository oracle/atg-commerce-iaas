...
__module__ = "create-security-association"
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
...
def readModuleArgs(opts, args):
    ...
    moduleArgs['seclist'] = None
    moduleArgs['vcable'] = None
    ...
    for opt, arg in opts:
        if opt in ("-e", "--endpoint"):
            ...
            moduleArgs['name'] = arg
        elif opt in ("-s", "--seclist"):
            moduleArgs['seclist'] = arg
        elif opt in ("-V", "--vcable"):
            moduleArgs['vcable'] = arg
...
def main(argv):
    ...
    try:
        ...
        if moduleArgs['cookie'] is not None:
            jsonObj = createSecurityAssociation(moduleArgs['endpoint'], moduleArgs['resourcename'],
                                                moduleArgs['cookie'],
                                                moduleArgs['seclist'], moduleArgs['vcable'], moduleArgs['name'])
            printJSON(jsonObj)
        else:
