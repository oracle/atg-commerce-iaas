...
__module__ = "update-security-list"
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
...
def updateSecurityList(endpoint, resourcename, cookie, name, policy=None, outboundcidrpolicy=None, **kwargs):
    basepath = '/seclist/'
    params = None
    data = {"name": name}
...
def main(argv):
    ...
    try:
        ...
        if moduleArgs['cookie'] is not None:
            jsonObj = updateSecurityList(moduleArgs['endpoint'], moduleArgs['resourcename'], moduleArgs['cookie'],
