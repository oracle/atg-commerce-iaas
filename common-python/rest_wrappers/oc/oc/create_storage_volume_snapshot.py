...
__module__ = "create-storage-volume-snapshot"
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
...
def createStorageVolumeSnapshot(endpoint, resourcename, cookie, name, description, property_="/oracle/private/storage/snapshot/collocated", volume="", tags=None, **kwargs):
    basepath = '/storage/snapshot/'
    params = None
    data = {"property": property_, "volume": volume}
    if name is not None:
        data['name'] = name
...
def readModuleArgs(opts, args):
    ...
    moduleArgs['property_'] = "/oracle/private/storage/snapshot/collocated"
    moduleArgs['volume'] = None
    ...
    for opt, arg in opts:
        ...
        elif opt in ("-S", "--property"):
            moduleArgs['property'] = arg
        elif opt in ("-V", "--volume"):
            moduleArgs['volume'] = arg
        elif opt in ("-t", "--tags"):
            moduleArgs['tags'] = arg
    return moduleArgs
...
def main(argv):
    ...
    options = 'e:u:p:P:R:C:n:D:S:V:t:'
    longOptions = ['endpoint=', 'user=', 'password=', 'pwdfile=', 'resourcename=', 'cookie=', 'name=', 'description=', 'property=', 'volume=', 'tags=']
    ...
    try:
        ...
        if moduleArgs['cookie'] is not None:
            jsonObj = createStorageVolumeSnapshot(moduleArgs['endpoint'], moduleArgs['resourcename'], moduleArgs['cookie'],
                                          moduleArgs['name'], moduleArgs['description'], moduleArgs['property_'], moduleArgs['volume'], moduleArgs['tags'])
            printJSON(jsonObj)
        else:
