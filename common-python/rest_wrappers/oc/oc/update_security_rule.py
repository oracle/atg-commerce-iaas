...
__module__ = "update-security-rule"
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
...
def updateSecurityRule(endpoint, resourcename, cookie, name, srclist, dstlist, application, action='PERMIT',
...
def main(argv):
    ...
    try:
        ...
        if moduleArgs['cookie'] is not None:
            jsonObj = updateSecurityRule(moduleArgs['endpoint'], moduleArgs['resourcename'], moduleArgs['cookie'],
