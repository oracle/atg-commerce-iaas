...
__module__ = "orchestration_helper"
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
...
instance_flags = {'atg': ['--java', '--atg', '--atgpatch'],
                  'weblogic': ['--java', '--weblogic', '--weblogicDomain', '--weblogicSettings', '--weblogicDatasources'],
...
def create_os_instance_yaml(section_name, project_name):
    ...
    script_data['script'] = wrapper_script + " " + compute_script_flags(instance_types, config_source)
...
def generate_instance_data(project_name, image_name):
    ...
    for section in sections:
        ...
        data['oplans'][0]['objects'][0]['instances'][0]['attributes']['userdata']['pre-bootstrap']['script'] = wrapper_script + " " + compute_script_flags(instance_types, config_source)
...
def compute_script_flags(instance_types, config_source):
