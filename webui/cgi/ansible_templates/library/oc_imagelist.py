...
from oc.update_imagelist import updateImagelist
from oc.delete_imagelist import deleteImagelist
...
def main():
    module = AnsibleModule(
            argument_spec = dict(
                    ...
                    default         = dict(required=False, type='int')
            )
    )
