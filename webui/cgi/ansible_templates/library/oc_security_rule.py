...
from oc.create_security_rule import createSecurityRule
from oc.list_security_rules import listSecurityRules
from oc.update_security_rule import updateSecurityRule
from oc.delete_security_rule import deleteSecurityRule
...
def main():
    ...
    if module.params['action'] == 'create':
        jsonobj = createSecurityRule(endpoint, resourcename, cookie, name, srclist, dstlist, application, ruleaction, description, disabled)
