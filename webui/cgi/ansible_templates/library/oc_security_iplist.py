...
from oc.list_security_ip_lists import listSecurityIpLists
from oc.update_security_ip_list import updateSecurityIpList
from oc.delete_security_ip_list import deleteSecurityIpList
...
def main():
    module = AnsibleModule(
            argument_spec = dict(
                    ...
                    secipentries    = dict(required=False, type='str'),
    ...
    secipentries = module.params['secipentries']
