...
from oc.create_ip_reservation import createIPReservation
from oc.list_ip_reservations import listIPReservations
from oc.update_ip_reservation import updateIPReservation
from oc.delete_ip_reservation import deleteIPReservation
...
def main():
    module = AnsibleModule(
            argument_spec = dict(
                    ...
                    parentpool     = dict(required=False, type='str', default='/oracle/public/ippool'),
    ...
    if module.params['action'] == 'create':
        jsonobj = createIPReservation(endpoint, resourcename, cookie, name, parentpool, permanent)
